...
import (
	...
	"github.com/WinPooh32/git/internal" //nolint:depguard // only this file can use the internal type CmdArg, other files and packages should use AddXxx functions
	"github.com/WinPooh32/git/log"
	"github.com/WinPooh32/git/process"
